                ...
                <ul className="mb-6 md:mb-0">
                  <li className="flex">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className=" text-slate-400">1230 Maecenas Street Donec Road</p>
                      <p className=" text-slate-400">New York, EEUU</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className=" text-slate-400">Mail: tailnext@gmail.com</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className=" text-slate-400">Monday - Friday: 08:00 - 17:00</p>
                      <p className=" text-slate-400">Saturday &amp; Sunday: 08:00 - 12:00</p>
                    </div>
                  </li>
                </ul>
              </div>
